...
def scatter_in_platform_area( target_rep,rep_list,fixed_first = True):
    ...
    scatter3D_obb_in_boundary(rep_list, boundary=np.array([area_obb.min(0),area_obb.max(0)]), fixed_first=fixed_first)
